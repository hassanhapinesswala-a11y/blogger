...
<title>Write — Blogger-Style</title>
<style>
...
<div class="container">
  <form class="card" method="post" action="save_post.php" onsubmit="syncContent()">
    <label>Title</label>
    <input required name="title" placeholder="Enter a catchy headline" />
    <label>Author</label>
    ...
    <div id="editor" class="editor" contenteditable="true" placeholder="Write your story…"></div>
...
<script>
  ...
  function syncContent(){
    document.getElementById('content').value = document.getElementById('editor').innerHTML.trim();
  }
</script>
</body>
</html>
